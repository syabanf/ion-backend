// Package postgres implements driven adapters for the enterprise
// bounded context against PostgreSQL.
//
// Same conventions as the warehouse + crm postgres packages:
...
//   - Queries scoped to the enterprise schema (`enterprise.*`).
package postgres
...
// strings. Mirror of warehouse/adapter/postgres/shared.go — kept
