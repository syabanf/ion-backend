// Package network hosts the SQL-only bridge from operations into the
// network bounded context. No Go imports of internal/network.
package network
...
// errors. Local copy so this bridge package stays independent.
