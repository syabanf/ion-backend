// Package postgres holds driven adapters for the warehouse bounded context.
package postgres
...
// mapDBError translates well-understood Postgres errors to domain errors.
// SQLSTATE 23505 = unique_violation, 23503 = foreign_key_violation,
// 23514 = check_violation. Everything else stays Internal with the cause.
